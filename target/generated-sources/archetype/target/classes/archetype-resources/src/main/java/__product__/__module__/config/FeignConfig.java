package ${package}.${product}.${module}.config;

import ${package}.${product}.${module}.feign.DemoService;
import ${package}.${product}.${module}.feign.interceptors.MyBasicAuthRequestInterceptor;
...
public class FeignConfig {
  ...
  @Value("${symbol_dollar}{feign.service.example.url:https://www.baidu.com}")
